 ...
 * {@link KiemTraTuVungFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link KiemTraTuVungFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class KiemTraTuVungFragment extends Fragment {
    ...
    private Button btnKiemTraTuVung;

    private Map.Entry<String, String> cauHoiDich;
     ...
     * @return A new instance of fragment KiemTraTuVungFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static KiemTraTuVungFragment newInstance(String param1, String param2) {
        KiemTraTuVungFragment fragment = new KiemTraTuVungFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root=inflater.inflate(R.layout.fragment_kiem_tra_tu_vung, container, false);
        btnKiemTraTuVung=(Button) root.findViewById(R.id.btnKiemTraTuVung);
        btnKiemTraTuVung.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                clickNoi();
            }
        });
        tvCauCanDich=(TextView) root.findViewById(R.id.tvCauCanDich);
        tvCauCanDich.setText("");
    ...
    public void clickNoi() {
        ...
        intent.putExtra(RecognizerIntent.EXTRA_PROMPT, cauHoiDich.getKey());
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch (requestCode) {
            case KiemTraActivity.REQUES_CODE:
                if (resultCode == KiemTraActivity.RESULT_OK && data != null) {
                    ...
                    tvCauTraLoiCuaNguoiDung.setText("Người dùng nói là: " + txt.get(0));
                    tvDapAn.setText("Đáp án: "+cauHoiDich.getValue());
                    if(cauHoiDich.getValue().trim().toLowerCase().equals(txt.get(0).trim().toLowerCase())) {
                        KiemTraActivity.diemTungPhan[1]++;
        ...
        daTraLoiXong();
        btnKiemTraTuVung.setClickable(false);
        btnKiemTraTuVung.setAlpha(0.2f);
